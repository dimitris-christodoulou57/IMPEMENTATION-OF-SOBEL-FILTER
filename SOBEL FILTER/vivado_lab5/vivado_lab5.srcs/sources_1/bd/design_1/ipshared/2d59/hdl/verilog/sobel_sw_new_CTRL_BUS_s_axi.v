...
#(parameter
    ...
    input  wire                          ap_ready,
    input  wire                          ap_idle,
    output wire [31:0]                   input_r_r,
    output wire [31:0]                   output_r_r
);
//------------------------Address Info-------------------
...
localparam
    ...
    ADDR_IER               = 5'h08,
    ADDR_ISR               = 5'h0c,
    ADDR_INPUT_R_R_DATA_0  = 5'h10,
    ADDR_INPUT_R_R_CTRL    = 5'h14,
    ADDR_OUTPUT_R_R_DATA_0 = 5'h18,
    ADDR_OUTPUT_R_R_CTRL   = 5'h1c,
    WRIDLE                 = 2'd0,
    WRDATA                 = 2'd1,
    WRRESP                 = 2'd2,
    WRRESET                = 2'd3,
...
//------------------------Local signal-------------------
    ...
    reg  [31:0]                   int_input_r_r = 'b0;
    reg  [31:0]                   int_output_r_r = 'b0;
