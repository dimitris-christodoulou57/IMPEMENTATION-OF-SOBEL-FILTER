...
BEGIN DRIVER
 PARAMETER DRIVER_NAME = sobel_sw_new
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = sobel_sw_new_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = sobel_sw_new
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = sobel_sw_new_1
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = sobel_sw_new
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = sobel_sw_new_2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = sobel_sw_new
 PARAMETER DRIVER_VER = 1.0
 PARAMETER HW_INSTANCE = sobel_sw_new_3
END
